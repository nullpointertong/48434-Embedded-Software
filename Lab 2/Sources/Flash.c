...
*/
/*!
**  @addtogroup Flash_module packet module documentation
**  @{
*/
/* MODULE Flash */
...
//TODO	write function check address alignment

bool Flash_Init(void) 
{
  return true;
}
//TODO:REMOVE ALL REFERENCES TO FLASH AS THIS WILL COMPRIMISE FUNCTION ORDER
