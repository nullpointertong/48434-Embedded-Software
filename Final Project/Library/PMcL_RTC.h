 ...
 */
bool PMcL_RTC_Init(void (*userFunction)(void*), void* userArguments);
 ...
 */
void PMcL_RTC_Set(const uint8_t hours, const uint8_t minutes, const uint8_t seconds);
 ...
 */
void PMcL_RTC_Get(uint8_t* const hours, uint8_t* const minutes, uint8_t* const seconds);
 ...
 */
void __attribute__ ((interrupt)) PMcL_RTC_ISR(void);
