 ...
 */
bool PMcL_FTM_Set(const TFTMChannel* const aFTMChannel);
 ...
 *  @note Assumes the FTM has been initialized.
 */
bool PMcL_FTM_StartTimer(const TFTMChannel* const aFTMChannel);
 ...
 *  @note Assumes the FTM has been initialized.
 */
void __attribute__ ((interrupt)) PMcL_FTM0_ISR(void);
